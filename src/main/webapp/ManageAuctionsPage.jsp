		...
		<div class = "row">
			<div class = "col-lg-12">
				<div>
					...
					<h2 align="center">Manage Auctions</h2><br>
					<table id="cust_rep" style="width:100%" align="center">
						...
						%>
							<tr>
								...
								<td style="word-break: break-all"><%=result.getString("start_timestamp") %></td>
								<td style="word-break: break-all"><%=result.getString("end_timestamp") %></td>
								<td>
